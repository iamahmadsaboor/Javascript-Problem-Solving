...
for (let i = 0; i < str002.length; i++) {
  ...
  if (char === char.toUpperCase()) {
    // here will chk if the char is uppercase will enter this block else go to else block
...
let arrTwentyOneRotated = arrTwentyOne
  .slice(1)
  .concat(arrTwentyOne.slice(0, 1));
...
let arrTwentyTwoRotated = arrTwentyTwo
  .slice(0, arrTwentyTwo.length - 1)
  .concat(arrTwentyTwo.slice(1));
